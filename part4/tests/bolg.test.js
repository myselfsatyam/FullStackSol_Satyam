...
const listWithmultipleBlogs = [
    {
        title: "Satyam's  Peersonal Website",
        author: "Sam",
        url: "https://devSam.vercel.app/",
        likes: 1000000,
        id: "64c4a51b738fcb18586f765a"
    },
    {
        title: "Rohit's  Peersonal Website",
        author: "R45",
        url: "https://www.instagram.com/r45/",
        likes: 100000000,
...
describe('favourite blog', () => {
    ...
    maxlike = 0;
    listWithmultipleBlogs.forEach(blog => maxlike = (maxlike > blog.likes) ? maxlike : blog.likes);
    let favBlog = listWithmultipleBlogs[0];
    listWithmultipleBlogs.forEach(blog => favBlog = (blog.likes === maxlike) ? blog : favBlog);
